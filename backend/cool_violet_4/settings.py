"""
Django settings for cool_violet_4 project.
...
ROOT_URLCONF = 'cool_violet_4.urls'
...
WSGI_APPLICATION = 'cool_violet_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Cool Violet Support <support@cool-violet-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cool_violet_4 API",
    "DESCRIPTION": "API documentation for cool_violet_4 App",
    "VERSION": "v1",
}
